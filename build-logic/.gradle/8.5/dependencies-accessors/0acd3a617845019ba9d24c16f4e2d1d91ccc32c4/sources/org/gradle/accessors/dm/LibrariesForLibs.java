...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxMaterialIconsLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'materialIconsExtended'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxNavigation'.
            ...
            /**
             * Creates a dependency provider for runtime (androidx.navigation:navigation-runtime-ktx)
         * with versionRef 'androidxNavigation'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory {
        ...
        public RetrofitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for converterAdapter (com.squareup.retrofit2:adapter-rxjava2)
         * with versionRef 'retrofit'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getConverterAdapter() {
                return create("retrofit.converterAdapter");
        }
         ...
         * with versionRef 'retrofit'.
            ...
            public Provider<MinimalExternalModuleDependency> getConverterGson() {
                return create("retrofit.converterGson");
        }

            /**
             * Creates a dependency provider for converterScalars (com.squareup.retrofit2:converter-scalars)
         * with versionRef 'retrofit'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getConverterScalars() {
                return create("retrofit.converterScalars");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: activityKtx (1.10.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: core (1.16.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: hilt (2.47)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kotlinCompilerExtension (1.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: material3 (1.3.0-beta04)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: materialIconsExtended (1.7.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: versionName (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final CommonPluginAccessors paccForCommonPluginAccessors = new CommonPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.common
         */
        public CommonPluginAccessors getCommon() {
            return paccForCommonPluginAccessors;
        }
    ...
    public static class CommonPluginAccessors extends PluginFactory {
        private final CommonAndroidPluginAccessors paccForCommonAndroidPluginAccessors = new CommonAndroidPluginAccessors(providers, config);

        public CommonPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of plugins at plugins.common.android
         */
        public CommonAndroidPluginAccessors getAndroid() {
            return paccForCommonAndroidPluginAccessors;
        }

    }

    public static class CommonAndroidPluginAccessors extends PluginFactory {
        private final CommonAndroidApplicationPluginAccessors paccForCommonAndroidApplicationPluginAccessors = new CommonAndroidApplicationPluginAccessors(providers, config);
        private final CommonAndroidLibraryPluginAccessors paccForCommonAndroidLibraryPluginAccessors = new CommonAndroidLibraryPluginAccessors(providers, config);

        public CommonAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for common.android.feature to the plugin id 'gradlePlugins.android.feature'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFeature() { return createPlugin("common.android.feature"); }

            /**
             * Creates a plugin provider for common.android.hilt to the plugin id 'gradlePlugins.android.hilt'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getHilt() { return createPlugin("common.android.hilt"); }

        /**
         * Returns the group of plugins at plugins.common.android.application
         */
        public CommonAndroidApplicationPluginAccessors getApplication() {
            return paccForCommonAndroidApplicationPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.common.android.library
         */
        public CommonAndroidLibraryPluginAccessors getLibrary() {
            return paccForCommonAndroidLibraryPluginAccessors;
        }

    }

    public static class CommonAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public CommonAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for common.android.application to the plugin id 'gradlePlugins.android.application'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("common.android.application"); }

            /**
             * Creates a plugin provider for common.android.application.compose to the plugin id 'gradlePlugins.android.application.compose'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("common.android.application.compose"); }

    }

    public static class CommonAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public CommonAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for common.android.library to the plugin id 'gradlePlugins.android.library'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("common.android.library"); }

            /**
             * Creates a plugin provider for common.android.library.compose to the plugin id 'gradlePlugins.android.library.compose'
             * with version 'unspecified'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("common.android.library.compose"); }
